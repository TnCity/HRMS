...
namespace HRMS.BLL.Services
{
    public class AttendanceService
    {
        ...
        // 🔹 Process attendance from raw data (MAIN METHOD)
        public async Task ProcessAttendanceAsync()
        {
            await _context.Database.ExecuteSqlRawAsync("EXEC sp_ProcessAttendance");
        }
    }
}